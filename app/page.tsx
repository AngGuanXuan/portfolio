          ...
          <div className="flex md:flex-row flex-col justify-between my-20">
            ...
            <div className="md:w-6/12">
              <p className="text-justify">
                ...
                expert website development services – let's create a website
                that truly represents your brand and engages your audience
                effectively
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-wrap justify-between">
                <div className="md:w-9/12 w-full">
                  <p className="md:mb-0 mb-5 mt-5 md:text-2xl text-lg text-justify">
                    ...
                    significantly contribute to our team's success. Reliable,
                    positive, and insightful, they bring valuable perspectives.
                    It's a pleasure to work with someone so capable and
                    team-oriented. &#40; Generated by ChatGPT &#41; &quot;
                  </p>
                </div>
